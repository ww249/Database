    ...
    public partial class user4 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (dc.Read())
            {
                ...
                textBox2.Text = get_date(dc[1].ToString());
                textBox3.Text = get_date(dc[2].ToString());
                textBox4.Text = dc[3].ToString();
                rent_s = textBox4.Text;
                textBox5.Text = dc[4].ToString();
                return_s = textBox5.Text;
                if (dc[5].ToString() == "1") textBox6.Text = "800";// 押金默认800
                ...
                if (dc.Read())
                {
                    ...
                    {
                        MessageBox.Show(textBox4.Text + "存在");
                        // 显示门店满足要求的车辆
