...
namespace 租车管理系统
{
    public partial class user2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Dao dao = new Dao();
                string sql = $"exec res @id = '{Data.UID}',@type = '{cartype}',@rent_d = '{rentdate}',@return_d = '{returndate}',@rent_s = '{rentstore}',@return_s = '{returnstore}';";//需要改
        ...
        {
            // TODO: 这行代码将数据加载到表“car_rentDataSet.t_car_info”中。您可以根据需要移动或移除它。
            this.t_car_infoTableAdapter.Fill(this.car_rentDataSet.t_car_info);
            Table();
            //Table();
