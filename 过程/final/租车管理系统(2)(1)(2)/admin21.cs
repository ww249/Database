    ...
    public partial class admin21 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "")
            {
                ...
                {
                    sql = $"insert into t_car_info values('{textBox1.Text}','{textBox2.Text}','{textBox3.Text}');update t_type_info set type_num=type_num+1 where t_type_info.cartype='{textBox2.Text}';";
                    dao.Execute(sql);
                    ...
                    {
                        sql = $"insert into t_car_info values('{textBox1.Text}','{textBox2.Text}','{textBox3.Text}');";
                    dao.Execute(sql);
