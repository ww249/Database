...
namespace 租车管理系统
{
    public partial class admin3 : Form
    {
        ...
        public void Table()
        {
            ...
            Dao dao= new Dao();
            string sql = $"select *from t_store_info where if_exist=1";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        string sql = $"update t_store_info set if_exist = 0 where storeid = '{id}';";//sql语句出错啦,可能是外键
                        Dao dao = new Dao();
                ...
                {
                    MessageBox.Show("请先在表格选中要删除的门店记录！", "信息提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            da.DaoClose();
        }
